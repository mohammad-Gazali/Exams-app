...
class NormalUser(models.Model):
    ...
    gender = models.CharField(
        max_length=6, choices=GenderChoices.choices, verbose_name=_("gender")
    )
...
class Teacher(models.Model):
    ...
    cv = models.FileField(
        verbose_name=_("CV"), upload_to="teachers_cvs", null=True, blank=True
    )
    ...
    normal_user = models.OneToOneField(
        NormalUser, verbose_name=_("normal user"), on_delete=models.CASCADE
    )
